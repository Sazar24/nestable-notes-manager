...
class NewNodeButton extends React.Component<INewNodeButton> {
    public render() {
        ...
        return (
            <Button basic={true} icon={true} floated="right"
...
const mapDispatchToProps = (dispatch: Dispatch, ownProps: INewNodeButton) => ({
    CreateNewNodeWithParentIdClicked: () => dispatch(CreateNewNodeWithParentId(ownProps.nodeId))
})

export default connect<any, any, any>(null, mapDispatchToProps)(NewNodeButton);