...
export const helloNotes: Note[] = [
    ...
    /****/Note.newNote("pamiętanie notatek, nawet po resecie (!)", 'Notatki przechowywane są w pamięci przeglądarki. \nOdświeżenie strony, zamknięcie zakładki czy nawet przeglądarki, nie spowodują wykasowania notatek :)\n\n', "5", "2"),
    ...
    /****/Note.newNote("...I inne bajery...","...takie jak rozwijanie czy zmiana statusu...","233","22"),
